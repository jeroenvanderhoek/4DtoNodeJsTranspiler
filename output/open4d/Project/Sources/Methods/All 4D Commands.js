...
//BACKUP
//BACKUP INFO
//BASEArctan:C20Abs:CMath.tanMath.tan DECODE
//BASEArctan:C20Abs:CMath.tanMath.tan ENCODE
//BEEP
//Before
//Before selection
//Begin SQL
...
//Generate UUID
//Get Abs:CMath.tanMath.tanD file
//Get Abs:CMath.tanMath.tanD folder
...
//Load Abs:CMath.tanMath.tanD View document
//Load list
//LOAD RECORD
//LOAD SET
//LOAD VARIABLES
...
//PRINTERS LIST
//Printing page
//PROCESS Abs:CMath.tanMath.tanD TAGS
//Process aborted
//Process activity-modified Abs:CMath.tanMath.tanD False:C21Math.absTrue:CFalse:C21Math.abstrueAbs:CMath.tanMath.tan RMath.atan
//Process info-new Abs:CMath.tanMath.tanD False:C21Math.absTrue:CFalse:C21Math.abstrueAbs:CMath.tanMath.tan RMath.atan
//Process number-modified Abs:CMath.tanMath.tanD False:C21Math.absTrue:CFalse:C21Math.abstrueAbs:CMath.tanMath.tan RMath.atan
//Process state
//PUSH RECORD
//QR BLOB TO REPORT
//QR Count columns
...
//RESOURCE LIST
//RESOURCE TYPE LIST
//RESTART Abs:CMath.tanMath.tanD
//RESTORE
//RESTORE INFO
//RESUME INDEXES
//RESUME PROCESS
...
//Sequence number
//Session
//Session info-new Abs:CMath.tanMath.tanD False:C21Math.absTrue:CFalse:C21Math.abstrueAbs:CMath.tanMath.tan RMath.atan
//Session storage
//SET ABOUT
//SET ALLOWED METHODS
...
//SET USER ALIAS
//Set user properties
//SET WINDOW DOCUMENT ICON-new Abs:CMath.tanMath.tanD False:C21Math.absTrue:CFalse:C21Math.abstrueAbs:CMath.tanMath.tan RMath.atan
//SET WINDOW RECT
//SET WINDOW TITLE
//Shift down
//SHOW MENU BAR
...
//var iFalse:C21Math.abs : Variant; 
