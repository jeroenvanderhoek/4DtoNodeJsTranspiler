import Action info from "../$Dcommands/Action info.js";
import ACTIVITY SNAPSHOT from "../$Dcommands/ACTIVITY SNAPSHOT.js";
import Application info from "../$Dcommands/Application info.js";
import Arctan from "../$Dcommands/Arctan.js";
import BACKUP INFO from "../$Dcommands/BACKUP INFO.js";
import Begin SQL from "../$Dcommands/Begin SQL.js";
import End SQL from "../$Dcommands/End SQL.js";
import Call chain from "../$Dcommands/Call chain.js";
import Database measures from "../$Dcommands/Database measures.js";
import HTTP Parse message from "../$Dcommands/HTTP Parse message.js";
import Is window maximized from "../$Dcommands/Is window maximized.js";
import Is window reduced from "../$Dcommands/Is window reduced.js";
import Last field number from "../$Dcommands/Last field number.js";
import Last query path from "../$Dcommands/Last query path.js";
import Last query plan from "../$Dcommands/Last query plan.js";
import Last table number from "../$Dcommands/Last table number.js";
import License info from "../$Dcommands/License info.js";
import License usage from "../$Dcommands/License usage.js";
import Localized document path from "../$Dcommands/Localized document path.js";
import Localized string from "../$Dcommands/Localized string.js";
import Locked records info from "../$Dcommands/Locked records info.js";
import MEMORY STATISTICS from "../$Dcommands/MEMORY STATISTICS.js";
import Monitored activity from "../$Dcommands/Monitored activity.js";
import MOUSE POSITION from "../$Dcommands/MOUSE POSITION.js";
import On Backup Shutdown database method from "../$Dcommands/On Backup Shutdown database method.js";
import On Backup Startup database method from "../$Dcommands/On Backup Startup database method.js";
import On Drop database method from "../$Dcommands/On Drop database method.js";
import On Exit database method from "../$Dcommands/On Exit database method.js";
import On Host Database Event database method from "../$Dcommands/On Host Database Event database method.js";
import On Mobile App Action database method from "../$Dcommands/On Mobile App Action database method.js";
import On Mobile App Authentication database method from "../$Dcommands/On Mobile App Authentication database method.js";
import On REST Authentication database method from "../$Dcommands/On REST Authentication database method.js";
import On Server Close Connection database method from "../$Dcommands/On Server Close Connection database method.js";
import On Server Open Connection database method from "../$Dcommands/On Server Open Connection database method.js";
import On Server Shutdown database method from "../$Dcommands/On Server Shutdown database method.js";
import On Server Startup database method from "../$Dcommands/On Server Startup database method.js";
import On SQL Authentication database method from "../$Dcommands/On SQL Authentication database method.js";
import On Startup database method from "../$Dcommands/On Startup database method.js";
import On System Event database method from "../$Dcommands/On System Event database method.js";
import On Web Authentication database method from "../$Dcommands/On Web Authentication database method.js";
import On Web Connection database method from "../$Dcommands/On Web Connection database method.js";
import On Web Legacy Close Session database method from "../$Dcommands/On Web Legacy Close Session database method.js";
import REDUCE RESTORE WINDOW from "../$Dcommands/REDUCE RESTORE WINDOW.js";
import RESTORE INFO from "../$Dcommands/RESTORE INFO.js";
import Session storage from "../$Dcommands/Session storage.js";
import System info from "../$Dcommands/System info.js";
import Table fragmentation from "../$Dcommands/Table fragmentation.js";
import throw from "../$Dcommands/throw.js";
...
//BACKUP
//BACKUP INFO
//BASETan:C1=Arctan:C20 DECODE
//BASETan:C1=Arctan:C20 ENCODE
//BEEP
//Before
//Before selection
//Begin SQL
...
//Generate UUID
//Get Arctan:C20D file
//Get Arctan:C20D folder
...
//Load Arctan:C20D View document
//Load list
//LOAD RECORD
//LOAD SET
//LOAD VARIABLES
...
//PRINTERS LIST
//Printing page
//PROCESS Arctan:C20D TAGS
//Process aborted
//Process activity-modified Arctan:C20D Abs:C==True:CAbs:C==trueArctan:C20 RMath.tan
//Process info-new Arctan:C20D Abs:C==True:CAbs:C==trueArctan:C20 RMath.tan
//Process number-modified Arctan:C20D Abs:C==True:CAbs:C==trueArctan:C20 RMath.tan
//Process state
//PUSH RECORD
//QR BLOB TO REPORT
//QR Count columns
...
//Sequence number
//Session
//Session info-new Arctan:C20D Abs:C==True:CAbs:C==trueArctan:C20 RMath.tan
//Session storage
//SET ABOUT
//SET ALLOWED METHODS
...
//SET USER ALIAS
//Set user properties
//SET WINDOW DOCUMENT ICON-new Arctan:C20D Abs:C==True:CAbs:C==trueArctan:C20 RMath.tan
//SET WINDOW RECT
//SET WINDOW TITLE
//Shift down
//SHOW MENU BAR
